defmodule RealmsWeb.UserLive.Registration do
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{user: user}}} = socket)
    ...
    {:ok, redirect(socket, to: RealmsWeb.UserAuth.signed_in_path(socket))}
  end
  ...
  def handle_event("save", %{"user" => user_params}, socket) do
    case Accounts.register_user(user_params) do
      {:ok, _user} ->
        # Skip magic link email - user has password and can log in directly
        # {:ok, _} =
